...
public static class Copulas
{
    ...
    [ExcelFunction(Description = "Generate correlated uniform random numbers using Gaussian (Normal) copula. Returns values in [0,1] suitable for transforming to any marginal distribution.", Category = "Actuarial.Experimental")]
        ...
        [ExcelArgument(Description = "Random seed; leave blank for system seed")] object? seed = null)
    {
        ...
        {
            // MathNet's Cholesky throws this when the matrix is not positive
            // definite. Surface as #VALUE! to Excel rather than leaking text.
            return new object[,] { { ExcelError.ExcelErrorValue } };
        }
        catch (ArgumentException)
        {
            // Non-square / wrong-shape matrix that slipped past our up-front check.
            return new object[,] { { ExcelError.ExcelErrorValue } };
        }
    }
    ...
    [ExcelFunction(Description = "Generate correlated uniform random numbers using Student-t copula. Has tail dependence (unlike Gaussian copula), controlled by degrees of freedom. Lower df = stronger tail dependence.", Category = "Actuarial.Experimental")]
    ...
    [ExcelFunction(Description = "Generate a single row of correlated uniform random numbers using Student-t copula", Category = "Actuarial.Experimental")]
    ...
    [ExcelFunction(Description = "Generate correlated uniform random numbers using Clayton copula. Has LOWER tail dependence - good for modeling joint extreme losses. Bivariate only.", Category = "Actuarial.Experimental")]
        ...
        [ExcelArgument(Description = "Random seed; leave blank for system seed")] object? seed = null)
    {
        ...
        {
            // Numerical edge case (e.g. log of 0 from a degenerate sample) —
            // surface as #VALUE! rather than propagating the exception text.
            return new object[,] { { ExcelError.ExcelErrorValue } };
        }
    }
    ...
    [ExcelFunction(Description = "Clayton copula CDF: C(u,v) = (u^(-θ) + v^(-θ) - 1)^(-1/θ)", Category = "Actuarial.Experimental")]
    ...
    [ExcelFunction(Description = "Generate correlated uniform random numbers using Frank copula. Symmetric dependence with NO tail dependence. Bivariate only.", Category = "Actuarial.Experimental")]
    ...
    [ExcelFunction(Description = "Frank copula CDF: C(u,v) = -ln(1 + (exp(-θu)-1)(exp(-θv)-1)/(exp(-θ)-1)) / θ", Category = "Actuarial.Experimental")]
    ...
    [ExcelFunction(Description = "Generate correlated uniform random numbers using Gumbel copula. Has UPPER tail dependence - good for modeling joint extreme gains or survival. Bivariate only.", Category = "Actuarial.Experimental")]
    ...
    [ExcelFunction(Description = "Gumbel copula CDF: C(u,v) = exp(-((-ln u)^θ + (-ln v)^θ)^(1/θ))", Category = "Actuarial.Experimental")]
    ...
    [ExcelFunction(Description = "Convert Kendall's tau to copula theta parameter. Returns theta for the specified copula type.", Category = "Actuarial.Experimental")]
    ...
    [ExcelFunction(Description = "Calculate lower tail dependence coefficient for a copula.", Category = "Actuarial.Experimental")]
    ...
    [ExcelFunction(Description = "Calculate upper tail dependence coefficient for a copula.", Category = "Actuarial.Experimental")]
